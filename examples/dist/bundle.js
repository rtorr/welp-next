...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dispatcher_1 = __webpack_require__(160);
	var Store_1 = __webpack_require__(164);
	var Component_1 = __webpack_require__(167);
	var UPDATE_NUMBER = 'UPDATE_NUMBER';
	function update_number(value) {
	    return Dispatcher_1.default.dispatch({
	        type: UPDATE_NUMBER,
	        data: value
	    });
	}
	var DemoStore = new Store_1.default({ hello: {
	        count: 0
	    } }, function (action) {
	    switch (action.type) {
	        case UPDATE_NUMBER:
	            return DemoStore.replace(DemoStore.data().updateIn(['hello', 'count'], function (_) { return action.data; }));
	    }
	});
	var App = (function (_super) {
	    __extends(App, _super);
	    function App(props) {
	        _super.call(this, props, [DemoStore]);
	...
	react_dom_1.render(React.createElement(App, null), document.getElementById('example'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var immutable_1 = __webpack_require__(165);
